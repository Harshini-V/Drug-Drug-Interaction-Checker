...
#print(subset_pairs)
total_batches = (len(subset_pairs) + batch_size - 1) // batch_size
print(total_batches)
for batch_index in range(total_batches):
    output_file = os.path.join(output_dir, f"batch_{batch_index}_count.csv")
    ...
    subprocess.run(["python", "get_instance_count.py", str(batch_index)])
